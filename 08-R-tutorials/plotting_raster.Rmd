...
Once the necessary packages are loaded, we will start by creating a raster object from a pre-loaded ohwobpg database.  Specifically, we will be creating a raster object of SST for June of 2018.
...
ggplot(data = r_df, mapping = aes(x = x, y = y, color = Jun, fill = Jun)) +
  ...
  scale_color_viridis(na.value = "white") +
  # Add axes labels
  labs(x = "Lon",
       y = "Lat")
```
